...
# # Function to generate a report on the user's performance
# def generate_report(conversation_history):
#     report_prompt = "Please provide a report on my English speaking performance based on our conversation. Include feedback on my grammar, vocabulary, and fluency."
#     report_conversation = conversation_history + [{"role": "user", "content": report_prompt}]
#     report = get_ai_response(report_prompt, report_conversation)
#     print("\n--- Instant Report ---")
#     print(report)
#     print("--------------------")
...
#     print("Welcome to the Personal Chatbot!")
#     print("You can start speaking now. Say 'quit' to exit.")
#     conversation_history = [{"role": "system", "content": "You are a friendly and encouraging English tutor for children."}]
#     while True:
#         user_input = listen()
#         if user_input:
...
#         print(f"You have chosen: {scenario}")
#         print("You can start speaking now. Say 'quit' to exit.")
#         system_prompt = f"You are in a roleplay scenario: {scenario}. You are a friendly character in this scenario. I am a child learning English. Let's have a conversation."
